...
const Content = () => {
    ...
    return <Mailbox>{elements[currentIndex]}</Mailbox>
}

const Composer = () => {
    const { setIndex } = useContext(Context)
    return <MailboxForm onClick={() => setIndex(0)} />
}
    ...
    return (
        <BottomBar>
            ...
            >
                ...
                <h1
                    style={{
                        color: currentIndex !== 1 ? 'red' : 'black',
                    }}
                >
                    Mail
                </h1>
            ...
            >
                <Compose
                    fill={currentIndex === 1 ? 'red' : 'black'}
                />
                <h1 style={{ color: currentIndex === 1 && 'red' }}>
                    Compose
                </h1>
            </Button>
        </BottomBar>
