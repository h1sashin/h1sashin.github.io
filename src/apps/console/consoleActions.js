            ...
            case 'help':
                return (
                    ...
                    >
                        ...
                        >
                            <div style={{ width: '64px' }}>clear</div>
                        ...
                        >
                            <div style={{ width: '64px' }}>run</div>
                            Opens/closes the app passed in second
                            parameter example: `run files`
                            <br />
                        ...
                        >
                            <div style={{ width: '64px' }}>style</div>
                            Changes the style of this website, try
                            typing `style help` to display possible
                            changes
                        </div>
                    </div>
                )
