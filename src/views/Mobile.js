...
const Mobile = ({ theme }) =>{
    const [ getScreenHeight, updateScreenHeight ] = useState(window.innerHeight);
    ...
    return (
        <ThemeProvider theme={currentTheme}>
            <System>
                <Desktop>
                    <Warning>
                        This is not fully working app yet, some functions or buttons may not work or not work properly. Check this website on your PC or laptop to see functional version. I am working all the time to develop a mobile version of my app
                    </Warning>
                    <FilesIcon />
                    <MailboxIcon />
                    <SettingsIcon />
